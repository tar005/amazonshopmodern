...
using Ecommerce.Application.Features.Orders.Commands.Queries.GetOrdersById;
using Ecommerce.Application.Features.Orders.Commands.Queries.PaginationOrders;
...
namespace Ecommerce.Api.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        [ProducesResponseType((int)HttpStatusCode.OK)]
        public async Task<ActionResult<OrderVm>> CreateOrder([FromBody] UpdateOrderCommand request)
        {
            return await _mediator.Send(request);
        }
